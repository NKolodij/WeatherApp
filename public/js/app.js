...
weatherForm.addEventListener('submit', (e) => {
	...
	// console.log('testing'); // test the button's action
	...
	// use fetch to display the weather condition for the city of choice
	...
	response.json().then((data) => {
		...
		else
		{
			...
			cityState.textContent = data.weather.cityName + ", " + data.weather.stateName;
			...
			message3.textContent = "Feels Like: ";
			feelsLikeTemp.textContent = data.weather.feelsLikeTemp + "° F";
			message4.textContent = "Local " + data.weather.cityName + ", " + data.weather.stateName + " time: ";
			currentTime.textContent = data.weather.currentTime;
		}
	});
});
